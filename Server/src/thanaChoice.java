 ...
 * @author masum
 */
public class thanaChoice extends javax.swing.JFrame {

    /**
     * Creates new form thanaChoice
     */
    public thanaChoice() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(thanaChoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new thanaChoice().setVisible(true);
            }
        });
    }
